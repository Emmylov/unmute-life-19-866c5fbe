  ...
  const fetchReel = async () => {
    ...
    try {
      ...
      const safeReel: Reel = {
        ...
        duration: data.duration || null, // Default to null
        original_audio_volume: data.original_audio_volume || 1, // Default to 1
        overlay_audio_volume: data.overlay_audio_volume || 0, // Default to 0
